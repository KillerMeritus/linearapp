...
"[project]/store/projects-filter-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$3_$40$types$2b$react$40$19$2e$0$2e$10_react$40$19$2e$0$2e$0$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/zustand@5.0.3_@types+react@19.0.10_react@19.0.0/node_modules/zustand/esm/react.mjs [app-client] (ecmascript)");
;
const useProjectsFilterStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$3_$40$types$2b$react$40$19$2e$0$2e$10_react$40$19$2e$0$2e$0$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        filters: {
            health: [],
            priority: []
        },
        ...
        setFilter: (type, ids)=>set((state)=>({
                    filters: {
                        ...state.filters,
                        [type]: ids
                    }
                })),
        toggleFilter: (type, id)=>set((state)=>{
                const current = state.filters[type];
                const next = current.includes(id) ? current.filter((x)=>x !== id) : [
                    ...current,
                    id
                ];
                return {
        ...
        clearFilterType: (type)=>set((state)=>({
                    filters: {
                        ...state.filters,
                        [type]: []
                    }
...
"[project]/store/projects-display-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$3_$40$types$2b$react$40$19$2e$0$2e$10_react$40$19$2e$0$2e$0$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/zustand@5.0.3_@types+react@19.0.10_react@19.0.0/node_modules/zustand/esm/react.mjs [app-client] (ecmascript)");
;
const useProjectsDisplayStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$3_$40$types$2b$react$40$19$2e$0$2e$10_react$40$19$2e$0$2e$0$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        mode: 'board',
        columns: 'status',
        rows: 'none',
        ordering: 'manual',
        ...
        setOrdering: (ordering)=>set({
                ordering
            }),
        setShowClosed: (showClosed)=>set({
                showClosed
            }),
        toggleShowEmptyColumns: ()=>set((s)=>({
                    showEmptyColumns: !s.showEmptyColumns
                })),
        toggleProperty: (prop)=>set((state)=>{
...
//# sourceMappingURL=_a0de5818._.js.map