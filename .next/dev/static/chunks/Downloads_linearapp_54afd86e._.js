...
"[project]/Downloads/linearapp/store/team-filter-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const useTeamsFilterStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$linearapp$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$3_$40$types$2b$react$40$19$2e$0$2e$10_react$40$19$2e$0$2e$0$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        filters: {
            membership: [],
            identifier: []
        },
        ...
        toggleFilter: (type, id)=>{
            set((state)=>{
                if (type === 'membership') {
                    ...
                    const typedId = id;
                    const next = current.includes(typedId) ? current.filter((ele)=>ele !== typedId) : [
                        ...current,
                        typedId
                    ];
                    return {
                    ...
                    const typedId = id;
                    const next = current.includes(id) ? current.filter((currentId)=>currentId !== typedId) : [
                        ...current,
                        typedId
                    ];
                    return {
...
//# sourceMappingURL=Downloads_linearapp_54afd86e._.js.map